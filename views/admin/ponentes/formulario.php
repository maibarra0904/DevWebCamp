<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="text" 
        class="formulario__input" id="apellido" 
        name="apellido" 
    ...
    <div class="formulario__campo">
        ...
        <input type="text" 
        class="formulario__input" id="ciudad" 
        name="ciudad" 
    ...
    <div class="formulario__campo">
        ...
        <input type="text" 
        class="formulario__input" id="pais" 
        name="pais" 
    ...
    <div class="formulario__campo">
        ...
        <input type="file" 
        class="formulario__input formulario__input--file" id="imagen" 
        name="imagen" 
        >
    </div>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="text" 
        class="formulario__input" id="tags_input" 
        placeholder="Ej. Node.js, PHP, CSS, Laravel, etc"
        >
